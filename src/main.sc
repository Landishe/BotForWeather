...
theme: /
    ...
    state: start
        ...
        script:
            $session = {}
            $temp = {}
        a: ** От разработчика:Бот находиться в стадии разработки. На данный момент релизован поиск города, ответ на погоду на сегодня и на недел. Что одеть в процессе разработки. На запрос о городе лучше отвечать "в Москве. Город в Именительном падеже" **
